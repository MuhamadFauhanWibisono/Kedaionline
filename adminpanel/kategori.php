            ...
            <?php
                if(isset($_POST['simpan_kategori'])){
                    ...
                    if ($jumlahDataKategoriBaru > 0){
                        ...
                        $querySimpan = mysqli_query($koneksi, "INSERT INTO kategori (nama) VALUES 
                        ('$kategori')");
                        ...
                        <meta http-equiv="refresh" content="5; url=kategori.php" />
                            <?php
                        }
                        else{
                         ...
                         <?php       
                          ...
                          ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <a href="kategori-detail.php?e=<?php echo 
                                            $data['id']; ?>" 
