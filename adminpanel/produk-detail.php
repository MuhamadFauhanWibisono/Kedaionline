<?php
    ...
    $query = mysqli_query($koneksi, "SELECT a.*, b.nama AS nama_kategori FROM produk a JOIN kategori b ON a.
        ...
        <h2>Detail Produk</h2>
            ...
            <div class="col-12 col-md-6 mb-5">
             ...
             ?>
                    ...
                    Nama, kategori dan harga wajib diisi yaa
                    </div>
             <?php
                        }
                        else{
                            $queryUpdate = mysqli_query($koneksi, "UPDATE produk SET kategori_id='$kategori',
               ...
               <?php
                ...
                <?php
                                        ...
                                        $queryUpdate = mysqli_query($koneksi, "UPDATE produk SET
